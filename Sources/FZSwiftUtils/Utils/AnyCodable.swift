...
extension _AnyEncodable {
    public func encode(to encoder: Encoder) throws {
        ...
        default:
            throw EncodingError.invalidValue(value, at: container.codingPath, debugDescription: "AnyEncodable value cannot be encoded")
        }
    }
    ...
    private func encode(nsnumber: NSNumber, into container: inout SingleValueEncodingContainer) throws {
        ...
        default:
            throw EncodingError.invalidValue(nsnumber, at: container.codingPath, debugDescription: "NSNumber cannot be encoded because its type is not handled")
        }
    }
}
