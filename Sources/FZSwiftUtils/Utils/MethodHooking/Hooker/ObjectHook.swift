...
struct ObjectHook<T: AnyObject> {
    ...
    public func revertHooks(for selector: Selector, type: HookMode? = nil) {
        Hook.Storage(object).revertHooks(for: selector, type: type)
    }
    
    public func revertAllHooks() {
        Hook.Storage(object).revertAllHooks()
    }
    
    public func isMethodHooked(_ selector: Selector, type: HookMode? = nil) -> Bool {
        Hook.Storage(object).isMethodHooked(selector, type: type)
    }
    ...
    @discardableResult
    func hookBefore(_ selector: Selector, closure: @escaping @convention(block) () -> Void) throws -> Hook {
        try hookBefore(selector, closure: closure as Any)
    }
    
    @discardableResult
    func hookBefore(_ selector: Selector, closure: @escaping (_ object: T) -> Void) throws -> Hook {
        try hookBefore(selector) { obj,_ in closure(obj) }
    }
    
    @discardableResult
    func hookBefore(_ selector: Selector, closure: @escaping (_ object: T, _ selector: Selector) -> Void) throws -> Hook {
    ...
    func hookBefore(_ selector: Selector, closure: Any) throws -> Hook {
        try Hook.Object(object, selector: selector, mode: .before, hookClosure: closure as AnyObject).apply(true)
    }
    
    // MARK: - Hook After
    
    @discardableResult
    func hookAfter(_ selector: Selector, closure: @escaping @convention(block) () -> Void) throws -> Hook {
        try hookAfter(selector, closure: closure as Any)
    }
    
    @discardableResult
    func hookAfter(_ selector: Selector, closure: @escaping (_ object: T) -> Void) throws -> Hook {
        try hookAfter(selector) { obj,_ in closure(obj) }
    }
        
    @discardableResult
    func hookAfter(_ selector: Selector, closure: @escaping (_ object: T, _ selector: Selector) -> Void) throws -> Hook {
        let closure = { obj, sel in
            guard let obj = obj as? T else { fatalError() }
            closure(obj, sel)
        } as @convention(block) (AnyObject, Selector) -> Void
    ...
    func hookAfter(_ selector: Selector, closure: Any) throws -> Hook {
        try Hook.Object(object, selector: selector, mode: .after, hookClosure: closure as AnyObject).apply(true)
    }
    ...
    func hook(_ selector: Selector, closure: Any) throws -> Hook {
        try Hook.Object(object, selector: selector, mode: .instead, hookClosure: closure as AnyObject).apply(true)
    }
    ...
    func hookDeinitAfter(closure: @escaping @convention(block) () -> Void) throws -> Hook {
        try Hook.Deinit(object, hookClosure: closure as AnyObject).apply(true)
    }
}
...
extension ObjectHook where T: NSObject {
    ...
    func hookDeinitBefore(closure: @escaping (_ object: T) -> Void) throws -> Hook {
        ...
        return try Hook.Object(object, selector: .dealloc, mode: .before, hookClosure: closure as AnyObject).apply(true)
    }
    
    @discardableResult
    func hookDeinitBefore(closure: @escaping @convention(block) () -> Void) throws -> Hook {
        try Hook.Object(object, selector: .dealloc, mode: .before, hookClosure: closure as AnyObject).apply(true)
    }
        
    @discardableResult
    func hookDeinit(closure: @escaping @convention(block) (_ original: () -> Void) -> Void) throws -> Hook {
        try Hook.Object(object, selector: .dealloc, mode: .instead, hookClosure: closure as AnyObject).apply(true)
    }
}
