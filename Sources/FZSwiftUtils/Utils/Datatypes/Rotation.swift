 ...
 */
public struct Rotation: Hashable, Codable, Sendable, CustomStringConvertible, ApproximateEquatable, Interpolatable {
...
private extension simd_quatd {
     ...
     */
    init(eulerAngles angles: Rotation.Angles, order: Rotation.AnglesOrder) {
     ...
     */
    func eulerAngles(order: Rotation.AnglesOrder) -> Rotation.Angles {
        let q = normalized
        let x = q.imag.x
        let y = q.imag.y
        let z = q.imag.z
