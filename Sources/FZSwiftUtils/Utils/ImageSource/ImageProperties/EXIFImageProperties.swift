...
public extension ImageSource.ImageProperties.EXIF {
    ...
    enum SensingMethod: Int, Codable {
        case notDefined = 1
    ...
    enum CustomRendered: Int, Codable {
        case normalProcess = 0
        case customProcess = 1
    }

    enum SceneCaptureType: Int, Codable {
        case standard = 0
        case landscape = 1
        case portrait = 2
        case nightScene = 3
    ...
    enum Contrast: Int, Codable {
        case normal = 0
        case soft = 1
        case hard = 2
    }

    enum Saturation: Int, Codable {
        case normal = 0
        case lowSaturation = 1
        case highSaturation = 2
    }

    enum Sharpness: Int, Codable {
        case normal = 0
        case soft = 1
        case hard = 2
    }

    enum SubjectDistanceRange: Int, Codable {
        case unknown = 0
        case macro = 1
        case closeView = 2
        case distantView = 3
    ...
    enum SensitivityType: Int, Codable {
        case unknown = 0
    ...
    enum ExposureProgram: Int, Codable {
        case notDefined = 0
        case manual = 1
    ...
    enum MeteringMode: String, Codable {
        case average
    ...
    enum WhiteBalance: String, Codable {
        case auto
        case manual
        case unknown
