...
public extension ImageProperties {
    struct DNG: RawRepresentable {
        ...
        public init(rawValue: [CFString: Any]) {
            ...
            baselineSharpness = rawValue[typed: kCGImagePropertyDNGBaselineSharpness]
            linearResponseLimit = rawValue[typed: kCGImagePropertyDNGLinearResponseLimit]
            chromaBlurRadius = rawValue[typed: kCGImagePropertyDNGChromaBlurRadius]
            antiAliasStrength = rawValue[typed: kCGImagePropertyDNGAntiAliasStrength]
            shadowScale = rawValue[typed: kCGImagePropertyDNGShadowScale]
            bestQualityScale = rawValue[typed: kCGImagePropertyDNGBestQualityScale]
            defaultScale = rawValue[kCGImagePropertyDNGDefaultScale]
            linearizationTable = rawValue[kCGImagePropertyDNGLinearizationTable]
            
            baselineExposure = rawValue[typed: kCGImagePropertyDNGBaselineExposure]
            baselineNoise = rawValue[typed: kCGImagePropertyDNGBaselineNoise]
            baselineExposureOffset = rawValue[typed: kCGImagePropertyDNGBaselineExposureOffset]
            
            analogBalance = rawValue[kCGImagePropertyDNGAnalogBalance]
            asShotNeutral = rawValue[kCGImagePropertyDNGAsShotNeutral]
            asShotWhiteXY = rawValue[kCGImagePropertyDNGAsShotWhiteXY]
            bayerGreenSplit = rawValue[typed: kCGImagePropertyDNGBayerGreenSplit]
            forwardMatrix1 = rawValue[kCGImagePropertyDNGForwardMatrix1]
            forwardMatrix2 = rawValue[kCGImagePropertyDNGForwardMatrix2]
            defaultBlackRender = rawValue[typed: kCGImagePropertyDNGDefaultBlackRender]
            
            blackLevelRepeatDim = rawValue[kCGImagePropertyDNGBlackLevelRepeatDim]
            blackLevel = rawValue[kCGImagePropertyDNGBlackLevel]
            blackLevelDeltaH = rawValue[kCGImagePropertyDNGBlackLevelDeltaH]
            blackLevelDeltaV = rawValue[kCGImagePropertyDNGBlackLevelDeltaV]
            whiteLevel = rawValue[kCGImagePropertyDNGWhiteLevel]
            calibrationIlluminant1 = rawValue[typed: kCGImagePropertyDNGCalibrationIlluminant1]
            calibrationIlluminant2 = rawValue[typed: kCGImagePropertyDNGCalibrationIlluminant2]
            colorMatrix1 = rawValue[typed: kCGImagePropertyDNGColorMatrix1]
            colorMatrix2 = rawValue[typed: kCGImagePropertyDNGColorMatrix2]
            cameraCalibration1 = rawValue[kCGImagePropertyDNGCameraCalibration1]
            cameraCalibration2 = rawValue[kCGImagePropertyDNGCameraCalibration2]
            reductionMatrix1 = rawValue[kCGImagePropertyDNGReductionMatrix1]
            reductionMatrix2 = rawValue[kCGImagePropertyDNGReductionMatrix2]
            asShotICCProfile = rawValue[kCGImagePropertyDNGAsShotICCProfile]
            asShotPreProfileMatrix = rawValue[kCGImagePropertyDNGAsShotPreProfileMatrix]
            currentICCProfile = rawValue[kCGImagePropertyDNGCurrentICCProfile]
            currentPreProfileMatrix = rawValue[kCGImagePropertyDNGCurrentPreProfileMatrix]
            colorimetricReference = rawValue[typed: kCGImagePropertyDNGColorimetricReference]
            cameraCalibrationSignature = rawValue[typed: kCGImagePropertyDNGCameraCalibrationSignature]
            profileCalibrationSignature = rawValue[typed: kCGImagePropertyDNGProfileCalibrationSignature]
            activeArea = rawValue[kCGImagePropertyDNGActiveArea]
            maskedAreas = rawValue[kCGImagePropertyDNGMaskedAreas]
            if let origin: [CGFloat] = rawValue[typed: kCGImagePropertyDNGDefaultCropOrigin], let x = origin[safe: 0], let y = origin[safe: 1] {
                defaultCropOrigin = CGPoint(x: x, y: y)
            } else {
                defaultCropOrigin = nil
            }
            if let size: [CGFloat] = rawValue[typed: kCGImagePropertyDNGDefaultCropSize], let width = size[safe: 0], let height = size[safe: 1] {
                defaultCropSize = CGSize(width: width, height: height)
            } else {
                defaultCropSize = nil
            }
            
            defaultUserCrop = rawValue[kCGImagePropertyDNGDefaultUserCrop]
            originalRawFileName = rawValue[typed: kCGImagePropertyDNGOriginalRawFileName]
            originalRawFileData = rawValue[kCGImagePropertyDNGOriginalRawFileData]
            noiseReductionApplied = rawValue[typed: kCGImagePropertyDNGNoiseReductionApplied]
            newRawImageDigest = rawValue[kCGImagePropertyDNGNewRawImageDigest]
            originalRawFileDigest = rawValue[kCGImagePropertyDNGOriginalRawFileDigest]
            rawImageDigest = rawValue[kCGImagePropertyDNGRawImageDigest]
            originalDefaultFinalSize = rawValue[kCGImagePropertyDNGOriginalDefaultFinalSize]
            originalBestQualityFinalSize = rawValue[kCGImagePropertyDNGOriginalBestQualityFinalSize]
            originalDefaultCropSize = rawValue[kCGImagePropertyDNGOriginalDefaultCropSize]
            rawToPreviewGain = rawValue[typed: kCGImagePropertyDNGRawToPreviewGain]
            noiseProfile = rawValue[kCGImagePropertyDNGNoiseProfile]
            cfaLayout = rawValue[typed: kCGImagePropertyDNGCFALayout]
            cfaPlaneColor = rawValue[kCGImagePropertyDNGCFAPlaneColor]
            opcodeList1 = rawValue[kCGImagePropertyDNGOpcodeList1]
            dngOpcodeList2 = rawValue[kCGImagePropertyDNGOpcodeList2]
            dngOpcodeList3 = rawValue[kCGImagePropertyDNGOpcodeList3]
            warpRectilinear = rawValue[kCGImagePropertyDNGWarpRectilinear]
            warpFisheye = rawValue[kCGImagePropertyDNGWarpFisheye]
            fixVignetteRadial = rawValue[kCGImagePropertyDNGFixVignetteRadial]
            dngPrivateData = rawValue[kCGImagePropertyDNGPrivateData]
            makerNoteSafety = rawValue[typed: kCGImagePropertyDNGMakerNoteSafety]
            dngRawDataUniqueID = rawValue[typed: kCGImagePropertyDNGRawDataUniqueID]
            subTileBlockSize = rawValue[kCGImagePropertyDNGSubTileBlockSize]
            rowInterleaveFactor = rawValue[typed: kCGImagePropertyDNGRowInterleaveFactor]
            dngBackwardVersion = rawValue[typed: kCGImagePropertyDNGBackwardVersion]
            dngVersion = rawValue[typed: kCGImagePropertyDNGVersion]
            extraCameraProfiles = rawValue[kCGImagePropertyDNGExtraCameraProfiles]
            asShotProfileName = rawValue[typed: kCGImagePropertyDNGAsShotProfileName]
            profileHueSatMapDims = rawValue[kCGImagePropertyDNGProfileHueSatMapDims]
            profileHueSatMapData1 = rawValue[kCGImagePropertyDNGProfileHueSatMapData1]
            profileHueSatMapData2 = rawValue[kCGImagePropertyDNGProfileHueSatMapData2]
            profileHueSatMapEncoding = rawValue[typed: kCGImagePropertyDNGProfileHueSatMapEncoding]
            profileToneCurve = rawValue[kCGImagePropertyDNGProfileToneCurve]
            dngProfileName = rawValue[typed: kCGImagePropertyDNGProfileName]
            profileEmbedPolicy = rawValue[typed: kCGImagePropertyDNGProfileEmbedPolicy]
            profileCopyright = rawValue[typed: kCGImagePropertyDNGProfileCopyright]
            profileLookTableDims = rawValue[kCGImagePropertyDNGProfileLookTableDims]
            profileLookTableData = rawValue[kCGImagePropertyDNGProfileLookTableData]
            profileLookTableEncoding = rawValue[typed: kCGImagePropertyDNGProfileLookTableEncoding]
            previewApplicationName = rawValue[typed: kCGImagePropertyDNGPreviewApplicationName]
            previewApplicationVersion = rawValue[typed: kCGImagePropertyDNGPreviewApplicationVersion]
            previewSettingsName = rawValue[typed: kCGImagePropertyDNGPreviewSettingsName]
            previewSettingsDigest = rawValue[typed: kCGImagePropertyDNGPreviewSettingsDigest]
            previewColorSpace = rawValue[typed: kCGImagePropertyDNGPreviewColorSpace]
            previewDateTime = rawValue[typed: kCGImagePropertyDNGPreviewDateTime, using: ImageProperties.dateFormatter]
            lensInfo = rawValue[typed: kCGImagePropertyDNGLensInfo]
            uniqueCameraModel = rawValue[typed: kCGImagePropertyDNGUniqueCameraModel]
            localizedCameraModel = rawValue[typed: kCGImagePropertyDNGLocalizedCameraModel]
            cameraSerialNumber = rawValue[typed: kCGImagePropertyDNGCameraSerialNumber]
        }
    }
}
