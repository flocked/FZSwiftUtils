...
public extension ImageFrameSequence {
    struct ImageFrameIterator: AsyncIteratorProtocol {
        ...
        public static func thumbnail(source: ImageSource, options: ThumbnailOptions? = nil, loop: Bool = false) -> ImageFrameIterator {
            return ImageFrameIterator(source: source, type: .thumbnail, thumbnailOptions: options, imageOptions: nil)
        }
        
        public static func image(source: ImageSource, options: ImageOptions? = nil, loop: Bool = false) -> ImageFrameIterator {
