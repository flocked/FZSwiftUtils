...
public extension NotificationCenter {
    /**
     ...
     - Parameters:
       ...
       - obj: The object to observe. Pass `nil` to receive notifications from any object.
       - queue: The operation queue on which to execute the block. Pass `nil` to use the default operation queue.
