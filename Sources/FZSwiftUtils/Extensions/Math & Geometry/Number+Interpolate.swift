...
public extension Sequence where Element: BinaryInteger {
    /**
     Interpolates the values of the sequence from one range to another range.
    ...
    /**
     Interpolates the values of the sequence to another range by using the minimum and maximum value inside the sequence.
