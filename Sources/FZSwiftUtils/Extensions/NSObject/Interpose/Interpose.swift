...
extension NSObject {
    /// A Boolean value indicating whether to enable logging when swizzling a method using `replaceMethod`
    public static var isLoggingEnabled: Bool {
        get { Interpose.isLoggingEnabled }
        set { Interpose.isLoggingEnabled = newValue }
    }
