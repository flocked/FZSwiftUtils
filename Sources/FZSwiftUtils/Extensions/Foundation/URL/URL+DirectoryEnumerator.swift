...
extension URL {
    ...
    // iterateFiles
    public func iterateFiles(options: Set<DirectoryEnumerationOption> = []) -> URLSequence {
        return iterate(predicate: {
            return $0.isFile }, options: options)
    }
    
    public func iterateFiles(options: DirectoryEnumerationOption...) -> URLSequence {
