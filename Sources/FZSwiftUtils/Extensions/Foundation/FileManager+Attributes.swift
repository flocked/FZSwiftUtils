...
public extension FileManager {
    struct Attributes {
        ...
        public var fileType: FileAttributeType? {
            get { if let rawValue: String = _attributes.fileType() {
        ...
        public var fileSize: DataSize {
            get { DataSize(Int(_attributes.fileSize())) }
        }
        ...
        public var directoryFilesCount: Int? {
            get { self[.referenceCount] }
        }
        
        public var deviceIdentifier: Double? {
            get { self[.deviceIdentifier] }
        }
        ...
        public var fileSystemNumber: Int {
            get { _attributes.fileSystemNumber() }
        }
        
        public var fileSystemFileNumber: Int {
            get { _attributes.fileSystemFileNumber() }
        }
        ...
        public var isReadOnly: Bool? {
            get { _attributes.fileIsAppendOnly() }
        }
        ...
        public var fileProtection: FileProtectionType? {
            get { if let rawValue: String = self[.protectionKey] {
        ...
        public var systemNodes: Int? {
            get { self[.systemNodes] }
        }
        
        public var systemFreeNodes: Int? {
            get { self[.systemFreeNodes] }
        }
        ...
        internal func getAttribute<T>(_ attribute: FileAttributeKey) -> T? {
            self.attributes[attribute] as? T
        }
        
        public subscript<T>(attribute: FileAttributeKey) -> T? {
            get { self.attributes[attribute] as? T }
            set {
